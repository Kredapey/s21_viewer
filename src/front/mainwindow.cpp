...
void MainWindow::on_move_x_Box_valueChanged(int arg1) {
  this->ui->GLwidget->move_x = arg1;
}

void MainWindow::on_move_y_Box_valueChanged(int arg1) {
  this->ui->GLwidget->move_y = arg1;
}

void MainWindow::on_move_z_Box_valueChanged(int arg1) {
  this->ui->GLwidget->move_z = arg1;
}

void MainWindow::on_rotation_x_Box_valueChanged(int arg1) {
  this->ui->GLwidget->rotation_x = arg1;
}

void MainWindow::on_rotation_y_Box_valueChanged(int arg1) {
  this->ui->GLwidget->rotation_y = arg1;
}

void MainWindow::on_rotation_z_Box_valueChanged(int arg1) {
...
void MainWindow::on_GIF_clicked() {
  filepath = QFileDialog::getSaveFileName(this, "Save as...", "untitled.gif",
                                          "GIF (*.gif)");
  if (filepath != nullptr) {
    connector_time();
    GIF_helper();
